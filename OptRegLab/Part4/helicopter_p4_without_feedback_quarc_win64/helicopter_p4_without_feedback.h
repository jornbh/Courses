/*
 * helicopter_p4_without_feedback.h
 *
 ...
 */
#ifndef RTW_HEADER_helicopter_p4_without_feedback_h_
#define RTW_HEADER_helicopter_p4_without_feedback_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helicopter_p4_without_feedback_COMMON_INCLUDES_
# define helicopter_p4_without_feedback_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helicopter_p4_without_feedback_COMMON_INCLUDES_ */

#include "helicopter_p4_without_feedback_types.h"
...
#define helicopter_p4_without_feedback_rtModel RT_MODEL_helicopter_p4_withou_T
...
} B_helicopter_p4_without_feedb_T;
...
typedef struct {
  ...
  struct {
    void *FilePtr;
  } ToFile_PWORK;                      /* '<S7>/To File' */

  struct {
    void *FilePtr;
  } ToFile1_PWORK;                     /* '<S7>/To File1' */

  struct {
    void *FilePtr;
  } ToFile2_PWORK;                     /* '<S7>/To File2' */

  struct {
    void *FilePtr;
  } ToFile3_PWORK;                     /* '<S7>/To File3' */

  struct {
    void *FilePtr;
  } ToFile4_PWORK;                     /* '<S7>/To File4' */

  struct {
    void *FilePtr;
  } ToFile5_PWORK;                     /* '<S7>/To File5' */
  ...
  struct {
    int_T Count;
    int_T Decimation;
  } ToFile_IWORK;                      /* '<S7>/To File' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile1_IWORK;                     /* '<S7>/To File1' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile2_IWORK;                     /* '<S7>/To File2' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile3_IWORK;                     /* '<S7>/To File3' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile4_IWORK;                     /* '<S7>/To File4' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile5_IWORK;                     /* '<S7>/To File5' */

  struct {
    int_T PrevIndex;
  } _IWORK;                            /* '<Root>/     ' */
} DW_helicopter_p4_without_feed_T;
...
} X_helicopter_p4_without_feedb_T;
...
} XDis_helicopter_p4_without_fe_T;
...
#define rtB                            helicopter_p4_without_feedbac_B
#define BlockIO                        B_helicopter_p4_without_feedb_T
#define rtX                            helicopter_p4_without_feedbac_X
#define ContinuousStates               X_helicopter_p4_without_feedb_T
#define rtXdot                         helicopter_p4_without_feed_XDot
#define StateDerivatives               XDot_helicopter_p4_without_fe_T
#define tXdis                          helicopter_p4_without_feed_XDis
#define StateDisabled                  XDis_helicopter_p4_without_fe_T
#define rtP                            helicopter_p4_without_feedbac_P
#define Parameters                     P_helicopter_p4_without_feedb_T
#define rtDWork                        helicopter_p4_without_feedba_DW
#define D_Work                         DW_helicopter_p4_without_feed_T

/* Parameters (auto storage) */
struct P_helicopter_p4_without_feedb_T_ {
  ...
  real_T ElevationTransferFcn_D;       /* Computed Parameter: ElevationTransferFcn_D
                                        * Referenced by: '<S4>/Elevation: Transfer Fcn'
                                        */
  real_T Gain_Gain_nm;                 /* Expression: 180/pi
...
struct tag_RTM_helicopter_p4_without_T {
  const char_T *path;
...
extern P_helicopter_p4_without_feedb_T helicopter_p4_without_feedbac_P;

/* Block signals (auto storage) */
extern B_helicopter_p4_without_feedb_T helicopter_p4_without_feedbac_B;

/* Continuous states (auto storage) */
extern X_helicopter_p4_without_feedb_T helicopter_p4_without_feedbac_X;

/* Block states (auto storage) */
extern DW_helicopter_p4_without_feed_T helicopter_p4_without_feedba_DW;

/* Model entry point functions */
extern void helicopter_p4_without_feedback_initialize(void);
extern void helicopter_p4_without_feedback_output(void);
extern void helicopter_p4_without_feedback_update(void);
extern void helicopter_p4_without_feedback_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helicopter_p4_withou_T *const helicopter_p4_without_feedba_M;
 ...
 *
 * '<Root>' : 'helicopter_p4_without_feedback'
 * '<S1>'   : 'helicopter_p4_without_feedback/Conversion'
 * '<S2>'   : 'helicopter_p4_without_feedback/Degrees to Radians'
 * '<S3>'   : 'helicopter_p4_without_feedback/Elevation controller'
 * '<S4>'   : 'helicopter_p4_without_feedback/Helicopter_interface'
 * '<S5>'   : 'helicopter_p4_without_feedback/LQR'
 * '<S6>'   : 'helicopter_p4_without_feedback/Pitch controller'
 * '<S7>'   : 'helicopter_p4_without_feedback/To file'
 * '<S8>'   : 'helicopter_p4_without_feedback/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helicopter_p4_without_feedback/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helicopter_p4_without_feedback/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helicopter_p4_without_feedback/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helicopter_p4_without_feedback/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helicopter_p4_without_feedback/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helicopter_p4_without_feedback/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_p4_without_feedback_h_ */
