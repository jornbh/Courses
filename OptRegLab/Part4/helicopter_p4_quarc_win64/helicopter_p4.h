 ...
 */
#ifndef RTW_HEADER_helicopter_p4_h_
#define RTW_HEADER_helicopter_p4_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helicopter_p4_COMMON_INCLUDES_
# define helicopter_p4_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helicopter_p4_COMMON_INCLUDES_ */

#include "helicopter_p4_types.h"
...
#define helicopter_p4_rtModel          RT_MODEL_helicopter_p4_T
...
typedef struct {
  ...
  struct {
    void *FilePtr;
  } writetofile_PWORK;                 /* '<S5>/ write to file ' */

  struct {
    void *FilePtr;
  } writetofile_PWORK_n;               /* '<S5>/write to file' */
  ...
  struct {
    int_T Count;
    int_T Decimation;
  } writetofile_IWORK;                 /* '<S5>/ write to file ' */

  struct {
    int_T Count;
    int_T Decimation;
  } writetofile_IWORK_g;               /* '<S5>/write to file' */
} DW_helicopter_p4_T;
...
#define rtB                            helicopter_p4_B
#define BlockIO                        B_helicopter_p4_T
#define rtX                            helicopter_p4_X
#define ContinuousStates               X_helicopter_p4_T
#define rtXdot                         helicopter_p4_XDot
#define StateDerivatives               XDot_helicopter_p4_T
#define tXdis                          helicopter_p4_XDis
#define StateDisabled                  XDis_helicopter_p4_T
#define rtP                            helicopter_p4_P
#define Parameters                     P_helicopter_p4_T
#define rtDWork                        helicopter_p4_DW
#define D_Work                         DW_helicopter_p4_T

/* Parameters (auto storage) */
struct P_helicopter_p4_T_ {
...
struct tag_RTM_helicopter_p4_T {
  const char_T *path;
...
extern P_helicopter_p4_T helicopter_p4_P;

/* Block signals (auto storage) */
extern B_helicopter_p4_T helicopter_p4_B;

/* Continuous states (auto storage) */
extern X_helicopter_p4_T helicopter_p4_X;

/* Block states (auto storage) */
extern DW_helicopter_p4_T helicopter_p4_DW;

/* Model entry point functions */
extern void helicopter_p4_initialize(void);
extern void helicopter_p4_output(void);
extern void helicopter_p4_update(void);
extern void helicopter_p4_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helicopter_p4_T *const helicopter_p4_M;
 ...
 *
 * '<Root>' : 'helicopter_p4'
 * '<S1>'   : 'helicopter_p4/Conversion'
 * '<S2>'   : 'helicopter_p4/Degrees to Radians'
 * '<S3>'   : 'helicopter_p4/Elevation controller'
 * '<S4>'   : 'helicopter_p4/Helicopter_interface'
 * '<S5>'   : 'helicopter_p4/LQR'
 * '<S6>'   : 'helicopter_p4/Pitch controller'
 * '<S7>'   : 'helicopter_p4/To file'
 * '<S8>'   : 'helicopter_p4/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helicopter_p4/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helicopter_p4/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helicopter_p4/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helicopter_p4/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helicopter_p4/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helicopter_p4/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_p4_h_ */
