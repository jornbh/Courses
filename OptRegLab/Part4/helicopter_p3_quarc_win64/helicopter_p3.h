 ...
 * '<S3>'   : 'helicopter_p3/Elevation controller'
 * '<S4>'   : 'helicopter_p3/Helicopter_interface'
 * '<S5>'   : 'helicopter_p3/LQR'
 * '<S6>'   : 'helicopter_p3/Pitch controller'
 * '<S7>'   : 'helicopter_p3/To file'
