...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&helicopter_B.ElevationCounttorad), 0, 0, 25 }
  ,
...
static DataTypeTransition rtPTransitions[] = {
  ...
  { (char_T *)(&helicopter_P.ElevationCounttorad_Gain), 0, 0, 34 },
