 ...
 * '<S2>'   : 'helicopter_p3/D2R '
 * '<S3>'   : 'helicopter_p3/Degrees to Radians'
 * '<S4>'   : 'helicopter_p3/Elevation controller'
 * '<S5>'   : 'helicopter_p3/Helicopter_interface'
 * '<S6>'   : 'helicopter_p3/LQR'
 * '<S7>'   : 'helicopter_p3/Pitch controller'
 * '<S8>'   : 'helicopter_p3/Write to file'
