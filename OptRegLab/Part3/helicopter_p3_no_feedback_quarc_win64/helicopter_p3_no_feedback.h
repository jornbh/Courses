 ...
 */
#ifndef RTW_HEADER_helicopter_p3_no_feedback_h_
#define RTW_HEADER_helicopter_p3_no_feedback_h_
#include <math.h>
#include <stddef.h>
#include <string.h>
#ifndef helicopter_p3_no_feedback_COMMON_INCLUDES_
# define helicopter_p3_no_feedback_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* helicopter_p3_no_feedback_COMMON_INCLUDES_ */

#include "helicopter_p3_no_feedback_types.h"
...
#define helicopter_p3_no_feedback_rtModel RT_MODEL_helicopter_p3_no_fee_T
...
} DW_helicopter_p3_no_feedback_T;
...
} XDis_helicopter_p3_no_feedbac_T;
...
#define rtB                            helicopter_p3_no_feedback_B
#define BlockIO                        B_helicopter_p3_no_feedback_T
#define rtX                            helicopter_p3_no_feedback_X
#define ContinuousStates               X_helicopter_p3_no_feedback_T
#define rtXdot                         helicopter_p3_no_feedback_XDot
#define StateDerivatives               XDot_helicopter_p3_no_feedbac_T
#define tXdis                          helicopter_p3_no_feedback_XDis
#define StateDisabled                  XDis_helicopter_p3_no_feedbac_T
#define rtP                            helicopter_p3_no_feedback_P
#define Parameters                     P_helicopter_p3_no_feedback_T
#define rtDWork                        helicopter_p3_no_feedback_DW
#define D_Work                         DW_helicopter_p3_no_feedback_T

/* Parameters (auto storage) */
struct P_helicopter_p3_no_feedback_T_ {
...
struct tag_RTM_helicopter_p3_no_feed_T {
  const char_T *path;
...
extern P_helicopter_p3_no_feedback_T helicopter_p3_no_feedback_P;

/* Block signals (auto storage) */
extern B_helicopter_p3_no_feedback_T helicopter_p3_no_feedback_B;

/* Continuous states (auto storage) */
extern X_helicopter_p3_no_feedback_T helicopter_p3_no_feedback_X;

/* Block states (auto storage) */
extern DW_helicopter_p3_no_feedback_T helicopter_p3_no_feedback_DW;

/* Model entry point functions */
extern void helicopter_p3_no_feedback_initialize(void);
extern void helicopter_p3_no_feedback_output(void);
extern void helicopter_p3_no_feedback_update(void);
extern void helicopter_p3_no_feedback_terminate(void);

/* Real-time Model object */
extern RT_MODEL_helicopter_p3_no_fee_T *const helicopter_p3_no_feedback_M;
 ...
 *
 * '<Root>' : 'helicopter_p3_no_feedback'
 * '<S1>'   : 'helicopter_p3_no_feedback/Conversion'
 * '<S2>'   : 'helicopter_p3_no_feedback/D2R '
 * '<S3>'   : 'helicopter_p3_no_feedback/Degrees to Radians'
 * '<S4>'   : 'helicopter_p3_no_feedback/Elevation controller'
 * '<S5>'   : 'helicopter_p3_no_feedback/Helicopter_interface'
 * '<S6>'   : 'helicopter_p3_no_feedback/Pitch controller'
 * '<S7>'   : 'helicopter_p3_no_feedback/Write to file'
 * '<S8>'   : 'helicopter_p3_no_feedback/Helicopter_interface/Elevation rad to deg'
 * '<S9>'   : 'helicopter_p3_no_feedback/Helicopter_interface/Elevation rate rad to deg'
 * '<S10>'  : 'helicopter_p3_no_feedback/Helicopter_interface/Pitch rad to deg'
 * '<S11>'  : 'helicopter_p3_no_feedback/Helicopter_interface/Pitch rate rad to deg'
 * '<S12>'  : 'helicopter_p3_no_feedback/Helicopter_interface/Pitch rate rad to deg1'
 * '<S13>'  : 'helicopter_p3_no_feedback/Helicopter_interface/Travel rad to deg'
 * '<S14>'  : 'helicopter_p3_no_feedback/Helicopter_interface/Travel rate  rad to deg'
 */
#endif                                 /* RTW_HEADER_helicopter_p3_no_feedback_h_ */
