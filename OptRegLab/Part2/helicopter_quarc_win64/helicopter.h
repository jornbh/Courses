...
struct P_helicopter_T_ {
  ...
  real_T elevation_ref_Value;          /* Expression: 0
                                        ...
                                        */
  real_T Gain1_Gain_my;                /* Expression: pi/180
 ...
 * '<S5>'   : 'helicopter/D2R 3'
 * '<S6>'   : 'helicopter/D2R 4'
 * '<S7>'   : 'helicopter/Degrees to Radians'
 * '<S8>'   : 'helicopter/Elevation controller'
 * '<S9>'   : 'helicopter/Helicopter_interface'
 * '<S10>'  : 'helicopter/Pitch controller'
