...
typedef struct {
  ...
  real_T Outputfromsimulation;         /* '<Root>/Output from simulation' */
...
typedef struct {
  ...
  struct {
    ...
    void *DataPtr;
    void *RSimInfoPtr;
  } Outputfromsimulation_PWORK;        /* '<Root>/Output from simulation' */
  ...
  struct {
    int_T PrevIndex;
  } Outputfromsimulation_IWORK;        /* '<Root>/Output from simulation' */
 ...
 * '<S2>'   : 'helicopter_p2/D2R '
 * '<S3>'   : 'helicopter_p2/Degrees to Radians'
 * '<S4>'   : 'helicopter_p2/Elevation controller'
 * '<S5>'   : 'helicopter_p2/Helicopter_interface'
 * '<S6>'   : 'helicopter_p2/Pitch controller'
 * '<S7>'   : 'helicopter_p2/Write to file'
