  ...
  algorithm
    ...
    annotation (
      Icon(coordinateSystem(
          ...
          grid={1,1}), graphics={Text(extent={{-150,-100},{150,-140}},
            textString="%name"),Rectangle(extent={{-100,100},{100,-100}}),Line(
            points={{-70,-79},{-70,64}}, color={192,192,192}),Line(points={{-76,
            -70},{67,-70}}, color={192,192,192}),Polygon(
              ...
              pattern=LinePattern.None,
              fillColor={192,192,192},
              fillPattern=FillPattern.Solid),Line(points={{-70,-40},{-30,-40},{
            -30,40},{70,40}}),Line(points={{-30,-40},{30,-40},{30,40}}),Line(
            points={{-72,-40},{-68,-40}}, color={192,192,192})}),
      Diagram(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-100,-100},{100,100}},
          grid={1,1}), graphics={Line(points={{-70,-79},{-70,64}}, color={192,
            192,192}),Line(points={{-76,-70},{67,-70}}, color={192,192,192}),
            Polygon(
              points={{81,-70},{64,-64},{64,-76},{81,-70}},
              lineColor={192,192,192},
              pattern=LinePattern.None,
            ...
            -30,40},{70,40}}),Line(points={{-30,-40},{30,-40},{30,40}}),Line(
              ...
              points={{-29,40},{-72,40}},
              color={192,192,192},
              pattern=LinePattern.Dot),Line(points={{-72,-40},{-68,-40}}, color=
             {192,192,192}),Text(
              extent={{-93,47},{-72,33}},
              lineColor={192,192,192},
              textString="out_on"),Text(
              extent={{-94,-33},{-73,-47}},
              lineColor={192,192,192},
              textString="out_off"),Text(
              extent={{-90,96},{-50,82}},
              lineColor={192,192,192},
              textString="O2 Setpoint"),Text(
              extent={{65,-78},{95,-94}},
              lineColor={192,192,192},
              textString="NH4-N"),Text(
              extent={{-41,-74},{-19,-85}},
              lineColor={192,192,192},
              textString="off"),Text(
              extent={{20,-75},{39,-85}},
              ...
              extent={{-50,85},{80,45}},
              lineColor={192,192,192},
              textString="TwoPoint-Controller"),Line(points={{-1,-38},{3,-40},{
            -1,-42}}),Line(points={{3,42},{-2,40},{3,38}}),Line(points={{-32,2},
            {-30,-3},{-28,2}}),Line(points={{28,-2},{30,3},{32,-2}})}),
  ...
  equation
    ...
    annotation (
      Icon(coordinateSystem(
          ...
          extent={{-100,-100},{100,100}},
          grid={1,1}), graphics={Text(extent={{-150,-100},{150,-140}},
            textString="%name"),Line(points={{-70,-85},{-70,64}}, color={192,
            192,192}),Line(points={{-76,-70},{67,-70}}, color={192,192,192}),
            Polygon(
              points={{81,-70},{64,-64},{64,-76},{81,-70}},
              lineColor={192,192,192},
              ...
              pattern=LinePattern.None,
              fillColor={192,192,192},
              fillPattern=FillPattern.Solid),Line(points={{-70,-50},{-40,-50},{
            10,6},{58,21}}),Rectangle(extent={{-100,100},{100,-100}})}),
      Diagram(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-100,-100},{100,100}},
          grid={1,1}), graphics={Line(points={{-70,-85},{-70,64}}, color={192,
            192,192}),Line(points={{-76,-70},{78,-70}}, color={192,192,192}),
            Line(
              points={{11,6},{11,-69}},
              color={192,192,192},
              pattern=LinePattern.Dot),Line(points={{-72,-50},{-68,-50}}, color=
             {128,128,128}),Line(
              points={{54,15},{54,-71}},
              color={192,192,192},
              pattern=LinePattern.Dot),Line(
              ...
              textString="Q-RAS"),Text(
              extent={{59,-76},{101,-102}},
              lineColor={192,192,192},
              textString="Qinflow"),Text(
              extent={{-100,-43},{-70,-57}},
              lineColor={192,192,192},
              textString="Qmin"),Text(
              extent={{-100,23},{-70,9}},
              lineColor={192,192,192},
              textString="Qrain"),Text(
              extent={{-43,82},{79,46}},
              lineColor={192,192,192},
              pattern=LinePattern.Dash,
              lineThickness=1,
              textString="ReturnController"),Polygon(
              ...
              fillColor={192,192,192},
              fillPattern=FillPattern.Solid,
              textString="Qdry"),Text(
              extent={{31,-73},{61,-89}},
              lineColor={192,192,192},
              textString="Qmax"),Line(points={{-68,-50},{-40,-50},{11,7},{53,15}}),
            Text(
              extent={{-19,-17},{51,-46}},
              lineColor={192,192,192},
              fillColor={0,0,0},
              fillPattern=FillPattern.Solid,
              textString="RAS/Inflow Ratio")}),
  ...
  equation
    ...
    annotation (
      Icon(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-100,-100},{100,100}},
          grid={1,1}), graphics={Rectangle(extent={{-100,100},{100,-100}}),Text(
            extent={{-150,-100},{150,-140}}, textString="%name"),Line(points={{
            -70,-85},{-70,64}}, color={192,192,192}),Line(points={{-76,-70},{67,
            -70}}, color={192,192,192}),Polygon(
              points={{81,-70},{64,-64},{64,-76},{81,-70}},
              lineColor={192,192,192},
              pattern=LinePattern.None,
              fillColor={192,192,192},
              ...
              pattern=LinePattern.None,
              fillColor={192,192,192},
              fillPattern=FillPattern.Solid),Line(points={{-70,30},{-32,30},{-32,
            -11},{8,-11},{8,-50},{49,-50}})}),
      Diagram(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-100,-100},{100,100}},
          grid={1,1}), graphics={Line(points={{-70,-85},{-70,64}}, color={192,
            ...
            Line(
              ...
              fillColor={192,192,192},
              fillPattern=FillPattern.Solid,
              textString="u-Recycle"),Text(
              extent={{59,-76},{101,-102}},
              lineColor={192,192,192},
              textString="N03-N"),Polygon(
              points={{81,-70},{64,-64},{64,-76},{81,-70}},
              lineColor={192,192,192},
              pattern=LinePattern.None,
              fillColor={192,192,192},
              ...
              extent={{-7,-69},{23,-85}},
              lineColor={192,192,192},
              textString="Max"),Line(points={{-70,30},{-32,30},{-32,-11},{8,-11},
            {8,-50},{49,-50}}),Line(points={{-32,-68},{-32,-72}}, color={192,
            192,192}),Line(points={{8,-68},{8,-72}}, color={192,192,192}),Text(
              extent={{-96,-3},{-70,-18}},
              lineColor={192,192,192},
              textString="Ref."),Line(
              points={{-32,-11},{-70,-11}},
              ...
              extent={{-29,20},{12,2}},
              lineColor={192,192,192},
              textString="dQ(NO3-Min)"),Text(
              extent={{13,-21},{56,-42}},
              lineColor={192,192,192},
              textString="dQ(NO3-Max)"),Text(
              extent={{-47,74},{80,40}},
              lineColor={192,192,192},
              textString="RecycleController")}),
      ...
      Icon(coordinateSystem(
          ...
          grid={1,1}), graphics={Rectangle(extent={{-100,100},{100,-100}}),Text(
            ...
            -70}}, color={192,192,192}),Polygon(
              ...
              pattern=LinePattern.None,
              fillColor={192,192,192},
              fillPattern=FillPattern.Solid),Line(points={{-72,18},{-68,18}},
            color={192,192,192}),Line(points={{-70,18},{-37,18},{9,-41},{44,-41}})}),
      Diagram(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-100,-100},{100,100}},
          grid={1,1}), graphics={Line(points={{-70,-85},{-70,64}}, color={192,
            ...
            Line(
              ...
              extent={{-4,-70},{26,-86}},
              lineColor={192,192,192},
              textString="Max"),Line(points={{-72,18},{-68,18}}, color={192,192,
            192}),Line(points={{-37,-68},{-37,-72}}, color={192,192,192}),Text(
              extent={{-10,6},{29,-14}},
              lineColor={192,192,192},
              textString="d(NO3)"),Text(
              extent={{-61,69},{66,35}},
              lineColor={192,192,192},
              textString="RecycleController"),Line(points={{-70,18},{-37,18},{9,
            -41},{44,-41}}),Line(points={{9,-68},{9,-72}}, color={192,192,192})}),
      Documentation(info="Input signal is a Nitrate measurement
Output is a control signal between -1 and 1.
...
"));
  ...
  annotation (Documentation(info="This package provides a collection of \"conrollers\" that are needed for the
