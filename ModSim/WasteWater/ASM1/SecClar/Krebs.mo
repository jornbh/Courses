...
package Krebs "Secondary settling tank modelling by Krebs (ASM1)"
  ...
  package Interfaces "Partial models for Secondary Clarifier Model by Krebs"
    ...
    annotation (Documentation(info="This package contains partial models for ASM1 secondary clarifier models.
...
"));
  ...
  equation
    ...
    Waste.Xp = rXp*XR;
    Waste.Xnd = rXnd*XR;
    annotation (Documentation(info="This component models an ASM1 secondary clarifier based on Krebs conceptional model.
...
"), Diagram(coordinateSystem(
  ...
  annotation (Documentation(info="This package contains an ASM1 secondary clarifier model and an Interfaces sub-library
