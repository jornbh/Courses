...
model pump "ASM1 wastewater pump"
  ...
  Modelica.Blocks.Interfaces.RealInput u
    annotation (Placement(transformation(extent={{-99,15},{-79,35}})));
equation
  H = 0.5*(-Q_min + Q_max) + u*0.5*(-Q_min + Q_max) + Q_min;
  ...
  Out.Xnd = In.Xnd;
  Out.Salk = In.Salk;
  annotation (Documentation(info="This component models an ASM1 wastewater pump. It generates a wastewater flow
...
model EffluentSink "Receiving water (river)"
  ...
  annotation (Documentation(info="This component terminates an ASM1 wastewater treatment plant model e.g. the wastewater flow to the receiving water.
"));
end EffluentSink;
...
model SludgeSink "Wastesludge sink"
  ...
  annotation (Documentation(info="This component terminates the waste sludge stream of an ASM1 wastewater treatment plant model.
...
equation
  ...
  Out2.Xnd = In.Xnd;
  Out2.Salk = In.Salk;
  annotation (Documentation(info="This component divides one wastewater flow (ASM1) into two flows which are controlled by the signal u (0...1).
...
equation
  ...
  In.Xnd = Out.Xnd;
  In.Salk = Out.Salk;
  annotation (Documentation(info="This component measures the flow of an ASM1 wastewater stream and provides
