...
package PreClar "Primary clarifier modelling based on ASM1"
  ...
  equation
    ...
    annotation (Documentation(info="This is an ASM1 dynamic primary clarifier model based on the theory
...
"));
  ...
  equation
    ...
    MeasurePort.Xnd = (1 - n_X)*Xnd;
    MeasurePort.Salk = Salk;
    annotation (Documentation(info="This is an ASM1 static primary clarifier model based on the theory
by Otterpohl and Freund.
...
"));
  ...
  equation
    ...
    Out.Xnd = (1 - n_X)*Xnd;
    Out.Salk = Salk;
    annotation (Documentation(info="This is a special case of the ASM1 static primary clarifier model.
...
"));
  ...
  annotation (Documentation(info="This package provides one dynamic and two static ASM1 primary clarifier
