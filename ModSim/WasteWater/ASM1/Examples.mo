...
package Examples "Demonstration examples of the components of the ASM1 library"
  ...
  class SmallPlant "Small WWTP Configuration"
    ...
    Modelica.Blocks.Sources.Constant Constant1
      annotation (Placement(transformation(extent={{-67,-87},{-47,-67}})));
    ...
    WasteWater.ASM1.sensor_TSS sensor_TSS1
      annotation (Placement(transformation(extent={{32,14},{49,30}})));
  equation
    connect(tank3.Out, divider.In) annotation (Line(points={{14,4},{20,4}}));
    connect(mixer.Out, tank1.In)
      annotation (Line(points={{-84,32},{-77,32},{-77,4},{-65,4}}));
    ...
    connect(Temperature.y, tank1.T) annotation (Line(points={{-81.5,56},{-71,56},
            {-71,8},{-65,8}}, color={0,0,255}));
    connect(Temperature.y, tank2.T) annotation (Line(points={{-81.5,56},{-39,56},
            {-39,8},{-34,8}}, color={0,0,255}));
    ...
    connect(Constant1.y, blower1.u) annotation (Line(points={{-46,-77},{-7.2,-77},
            {-7.2,-55},{-14.2,-55}}, color={0,0,255}));
    ...
    connect(blower1.AirOut, tank2.AirIn)
      annotation (Line(points={{-23,-42},{-23,-24},{-24,-24},{-24,-6}}));
    ...
    connect(Settler.Effluent, Effluent.In)
      annotation (Line(points={{69.2,11.7},{78,11.7},{78,-15},{88,-15}}));
    connect(Settler.Return, ReturnPump.In)
      annotation (Line(points={{56,-4.6},{56,-22.7},{36,-22.7}}));
    ...
    connect(sensor_NH1.In, Settler.Effluent)
      annotation (Line(points={{72,15},{72,11.7},{69.2,11.7}}));
    connect(sensor_NO1.In, Settler.Effluent)
      annotation (Line(points={{89,15},{89,11.7},{69.2,11.7}}));
    connect(sensor_TKN1.In, Settler.Effluent)
      annotation (Line(points={{105,14},{105,11.7},{69.2,11.7}}));
    connect(sensor_COD1.In, Settler.Effluent)
      annotation (Line(points={{105,-5},{105,11.7},{69.2,11.7}}));
    connect(Constant2.y, ReturnPump.u) annotation (Line(points={{43,-58},{48,-58},
            {48,-28.5},{34.9,-28.5}}, color={0,0,255}));
    connect(divider.Out1, Settler.Feed)
      annotation (Line(points={{40,7},{44.5,7},{44.5,7.4},{49,7.4}}));
    connect(tank3.MeasurePort, sensor_O2.In)
      annotation (Line(points={{10,9},{10,25}}));
    connect(sensor_TSS1.In, divider.Out1)
      annotation (Line(points={{40,14},{40,6}}));
    annotation (Diagram(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-120,-100},{120,105}},
          grid={1,1}), graphics={Line(points={{-22,58},{-22,58}}, color={0,0,
            255})}), Documentation(info="This fictitious plant provides an ASM1 example model with a small number of equations.
...
"));
  ...
  class BenchPlant "COST Benchmark WWTP Configuration"
    ...
    extends Modelica.Icons.Example;
    ASM1.EffluentSink Effluent
      annotation (Placement(transformation(extent={{105,-28},{125,-8}})));
    ASM1.SludgeSink WasteSludge
    ...
    ASM1.WWSource WWSource
      annotation (Placement(transformation(extent={{-177,48},{-157,68}})));
    ...
    Modelica.Blocks.Sources.Constant Q_a(k=55338) annotation (Placement(
          transformation(
          extent={{-5,-5.5},{5,5.5}},
          rotation=180,
          origin={-1,-29.5})));
    ...
    Modelica.Blocks.Sources.Constant Q_r(k=18446) annotation (Placement(
          transformation(
          extent={{-6,-6},{6,6}},
          rotation=180,
          origin={-31,-57})));
    ...
    WasteWater.ASM1.sensor_TKN sensor_TKN1
      annotation (Placement(transformation(extent={{97,14},{113,30}})));
    WasteWater.ASM1.sensor_COD sensor_COD1
      annotation (Placement(transformation(extent={{114,14},{130,30}})));
    WasteWater.ASM1.sensor_TSS sensor_TSS1
      annotation (Placement(transformation(extent={{32,15},{48,30}})));
    Modelica.Blocks.Sources.Constant Q_w(k=385) annotation (Placement(
          transformation(
          extent={{-5,-5.5},{5,5.5}},
          rotation=0,
          origin={52,-74.5})));
    WasteWater.ASM1.UD_Tank_5 tank5
      annotation (Placement(transformation(extent={{-6,-6},{14,14}})));
  equation
    connect(divider.Out1, Settler.Feed)
      annotation (Line(points={{40,6.6},{44,6.6},{44,6.4},{48,6.4}}));
    connect(tank3.Out, tank4.In) annotation (Line(points={{-40,4},{-32,4}}));
    connect(tank1.Out, tank2.In) annotation (Line(points={{-102,4},{-94,4}}));
    connect(mixer.Out, tank1.In)
      annotation (Line(points={{-130,3.6},{-126,3.6},{-126,4},{-122,4}}));
    connect(mixer.In1, WWSource.Out)
      annotation (Line(points={{-150,7.5},{-150,51},{-157.2,51}}));
    connect(sensor_NO.In, tank2.MeasurePort)
      annotation (Line(points={{-78,20},{-78,8.5},{-78.5,8.5}}));
    connect(RecyclePump.Out, mixer.In3)
      annotation (Line(points={{-81,-22.8},{-150,-22.8},{-150,-0.5}}));
    connect(Settler.Return, ReturnPump.In)
      annotation (Line(points={{55,-4.6},{55,-50.7},{-63,-50.7}}));
    connect(sensor_NH1.In, Settler.Effluent)
      annotation (Line(points={{72,15},{72,10.7},{68.2,10.7}}));
    connect(sensor_NO1.In, Settler.Effluent)
      annotation (Line(points={{89,15},{89,10.7},{68.2,10.7}}));
    connect(sensor_TKN1.In, Settler.Effluent)
      annotation (Line(points={{105,14},{105,10.7},{68.2,10.7}}));
    connect(sensor_COD1.In, Settler.Effluent)
      annotation (Line(points={{122,14},{122,10.7},{68.2,10.7}}));
    connect(Effluent.In, Settler.Effluent)
      annotation (Line(points={{105,-16},{78.5,-16},{78.5,10.7},{68.2,10.7}}));
    connect(sensor_TSS1.In, divider.Out1)
      annotation (Line(points={{40,15},{40,6.6}}));
    connect(tank2.Out, tank3.In)
      annotation (Line(points={{-74,4},{-60,4}}, color={0,0,0}));
    connect(ReturnPump.Out, mixer.In2) annotation (Line(points={{-83,-56.8},{-123,
            -56.8},{-123,-57},{-158,-57},{-158,3.5},{-150,3.5}}, color={0,0,0}));
    connect(Settler.Waste, WastePump.In) annotation (Line(points={{61,-4.6},{62,
            -4.6},{62,-51.3},{76,-51.3}}, color={0,0,0}));
    connect(divider.Out2, RecyclePump.In) annotation (Line(points={{40,2.5},{45,
            2.5},{45,-16.7},{-61,-16.7}}, color={0,0,0}));
    connect(WasteSludge.In, WastePump.Out)
      annotation (Line(points={{110,-45.2},{96,-45.2}}, color={0,0,255}));
    connect(Q_r.y, ReturnPump.u) annotation (Line(points={{-37.6,-57},{-54,-57},
            {-54,-56.5},{-64.1,-56.5}}, color={0,0,127}));
    ...
    connect(tank5.In, tank4.Out) annotation (Line(
        ...
        color={0,0,255},
        smooth=Smooth.None));
    connect(WastePump.u, Q_w.y) annotation (Line(
        points={{77.1,-45.5},{77.1,-45.25},{57.5,-45.25},{57.5,-74.5}},
        color={0,0,127},
        smooth=Smooth.None));
    connect(RecyclePump.u, Q_a.y) annotation (Line(
        points={{-62.1,-22.5},{-33.55,-22.5},{-33.55,-29.5},{-6.5,-29.5}},
        color={0,0,127},
        smooth=Smooth.None));
    annotation (Diagram(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-220,-100},{170,105}},
          grid={1,1}), graphics),
...
"),   experiment(
  ...
  model ComplexPlant "Complex ASM1 WWTP"
    ...
    Modelica.Blocks.Sources.CombiTimeTable CombiTableTime1(
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://WasteWater/Resources/ASM1/drysim130303.txt"),
      table=[0, 0; 1, 1],
      columns=integer(({2})),
    ...
    WasteWater.ASM1.sensor_TSS sensor_TSS2
      annotation (Placement(transformation(extent={{166,5},{184,24}})));
  equation
    ...
    connect(anaerob.Out, mixer3_1.In2) annotation (Line(points={{-118,23},{-110.5,
            23},{-110.5,24.5},{-107,24.5}}));
    ...
    connect(cdivider2.Out1, mixer2_2.In1)
      annotation (Line(points={{-22,80.5},{40,80.5},{40,29.5},{50,29.5}}));
    ...
    connect(Constant7.y, cdivider2.u) annotation (Line(points={{-55.5,103},{-50.5,
            103},{-50.5,54},{-32,54},{-32,72}}, color={0,0,255}));
    ...
    connect(blower1.AirOut, nitri3.AirIn)
      annotation (Line(points={{155,4},{155,5.5},{154,5.5},{154,18}}));
    ...
    connect(blower1.u, Gain2.y) annotation (Line(points={{165.8,-9},{195,-9},{
            195,103},{165,103}}, color={0,0,255}));
    connect(Settler.Feed, divider2_1.Out1)
      annotation (Line(points={{68,-72},{48,-72},{48,-35},{55,-35}}));
    ...
    connect(RecyclePump.Out, ControlledDivider2_1.In)
      annotation (Line(points={{-8.88178e-16,-40},{-30,-40}}));
    connect(RecyclePump.In, divider2_1.Out2)
      annotation (Line(points={{20,-33.7},{38,-33.7},{38,-31},{56,-31}}));
    connect(blower3.AirOut, nitri1.AirIn)
      annotation (Line(points={{22,-3},{22,14}}));
    connect(cdivider2.In, Preclaryfier.Out)
      annotation (Line(points={{-43,78},{-115,78}}));
    connect(blower2.AirOut, nitri2.AirIn)
      annotation (Line(points={{120,7},{120,18}}));
    connect(sensor_TSS2.In, nitri3.Out)
      annotation (Line(points={{175,5},{175,28},{163,28}}));
    annotation (Diagram(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-200,-120},{200,120}},
          grid={1,1}), graphics), Documentation(info="This ASM1 example plant configuration is from a real municipal wastewater treatment plant
...
"));
  ...
  equation
    ...
    rXi = Feed.Xi/Xf;
    rXnd = Feed.Xnd/Xf;
    annotation (Documentation(info="This component models an ASM1 10 - layer secondary clarifier with 6 layers above the feed_layer (including top_layer)
...
"));
  ...
  annotation (Documentation(info="This package contains example ASM1 wastewater treatment plant models to demonstrate the usage of
