...
package Examples "Demonstration examples of the components of the ASM3 library"
  ...
  class SmallPlant "Small WWTP Configuration"
    ...
    Modelica.Blocks.Sources.CombiTimeTable CombiTableTime(
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://WasteWater/Resources/ASM3/Inf_dry.txt"),
      table=[0, 0; 1, 1],
    ...
    sensor_NH sensor_NH1
      annotation (Placement(transformation(extent={{78,16},{94,32}})));
    sensor_NO sensor_NO1
      annotation (Placement(transformation(extent={{92,16},{108,32}})));
    sensor_COD sensor_COD1
      annotation (Placement(transformation(extent={{64,16},{80,32}})));
    SecClar.Krebs.SecClarModKrebs Settler
  ...
  equation
    ...
    connect(mixer.Out, tank1.In)
      annotation (Line(points={{-84,32},{-79,32},{-79,4},{-68,4}}));
    ...
    connect(PI1.y, blower2.u) annotation (Line(points={{109,50},{114,50},{114,-78},
            {18,-78},{18,-55},{13.9,-55}}));
    connect(divider.Out2, RecyclePump.In)
      annotation (Line(points={{40,2.2},{44,2.2},{44,-8.7},{-74,-8.7}}));
    ...
    connect(OxygenSetPoint.y, Feedback.u1)
      annotation (Line(points={{61,50},{64,50}}));
    connect(ReturnPump.Out, mixer.In2) annotation (Line(points={{15.8,-28.9},{-112,
            -28.9},{-112,32},{-104,32}}));
    ...
    connect(sensor_O2.So, Feedback.u2) annotation (Line(points={{19.8,28},{
            19.85,28},{19.85,34},{72,34},{72,42}}));
    ...
    connect(RecyclePump.u, Constant1.y) annotation (Line(points={{-75.2,-14},{-46,
            -14},{-46,-76},{-64,-76}}, color={0,0,255}));
    connect(Settler.Effluent, Effluent.In)
      annotation (Line(points={{70.2,13.7},{72,13.7},{72,-6},{88,-6}}));
    connect(Settler.Return, ReturnPump.In)
      annotation (Line(points={{57,-1.6},{57,-22.7},{36,-22.7}}));
    connect(Settler.Waste, WastePump.In)
      annotation (Line(points={{63,-1.6},{63,-20.7},{70,-20.7}}));
    connect(sensor_COD1.In, Settler.Effluent)
      annotation (Line(points={{72,16},{72,13.7},{70.2,13.7}}));
    connect(sensor_NH1.In, Settler.Effluent)
      annotation (Line(points={{86,16},{86,13.7},{70.2,13.7}}));
    connect(sensor_NO1.In, Settler.Effluent)
      annotation (Line(points={{100,16},{100,13.7},{70.2,13.7}}));
    connect(Settler.Feed, divider.Out1)
      annotation (Line(points={{50,8},{40,8}}));
...
"));
  ...
  class BenchPlant "COST Benchmark WWTP Configuration"
    ...
    ASM3.SludgeSink WasteSludge
      annotation (Placement(transformation(extent={{86,-58},{106,-38}})));
    ASM3.SecClarModTakacs Settler
      annotation (Placement(transformation(extent={{48,-2},{68,18}})));
    ASM3.divider2 divider
      annotation (Placement(transformation(extent={{20,-6},{40,14}})));
    ASM3.nitri tank5(
      K_A_NH=0.4,
    ...
    Modelica.Blocks.Sources.CombiTimeTable CombiTableTime(
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://WasteWater/Resources/ASM3/Inf_rain.txt"),
      table=[0, 0; 1, 1],
    ...
    sensor_NH sensor_NH1
      annotation (Placement(transformation(extent={{60,18},{76,34}})));
    WasteWater.ASM3.sensor_NO sensor_NO1
      annotation (Placement(transformation(extent={{92,18},{108,34}})));
    WasteWater.ASM3.sensor_COD sensor_COD1
      annotation (Placement(transformation(extent={{76,18},{92,34}})));
  equation
    connect(divider.Out1, Settler.Feed)
      annotation (Line(points={{40,7},{40,9.4},{48,9.4}}));
    ...
    connect(Settler.Effluent, Effluent.In)
      annotation (Line(points={{68.2,13.7},{72,13.7},{72,-4},{90,-4}}));
    connect(mixer.In1, WWSource.Out) annotation (Line(points={{-104,35.9},{-104,
    ...
    connect(tank5.MeasurePort, sensor_O2.In)
      annotation (Line(points={{9.5,8.5},{10,8.5},{10,18}}));
    connect(Feedback.y, PI1.u) annotation (Line(points={{81,50},{86,50}}));
    connect(PI1.y, blower3.u) annotation (Line(points={{109,50},{114,50},{114,-78},
            {18,-78},{18,-55},{13.9,-55}}));
    connect(Constant1.y, blower1.u) annotation (Line(points={{-63,-76},{-35.1,-76},
            {-35.1,-55},{-40.1,-55}}));
    connect(divider.Out2, RecyclePump.In)
      annotation (Line(points={{40,2.2},{44,2.2},{44,-8.7},{-74,-8.7}}));
    connect(RecyclePump.Out, mixer.In3) annotation (Line(points={{-94.2,-14.9},
    ...
    connect(Settler.Return, ReturnPump.In)
      annotation (Line(points={{55,-1.6},{55,-22.7},{36,-22.7}}));
    connect(ReturnPump.Out, mixer.In2) annotation (Line(points={{15.8,-28.9},{-112,
            -28.9},{-112,32},{-104,32}}));
    connect(Settler.Waste, WastePump.In)
      annotation (Line(points={{61,-1.6},{61,-27.3},{70,-27.3}}));
    ...
    connect(Temperature.y, tank2.T) annotation (Line(points={{-81.5,56},{-48,56},
            {-48,36}}, color={0,0,255}));
    ...
    connect(sensor_NH1.In, Settler.Effluent)
      annotation (Line(points={{68,18},{68,13.7}}));
    connect(sensor_COD1.In, Settler.Effluent)
      annotation (Line(points={{84,18},{84,14},{68,14}}));
    connect(sensor_NO1.In, Settler.Effluent)
      annotation (Line(points={{100,18},{100,14},{68.2,14}}));
    annotation (Diagram(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-118,-94},{118,98}},
          grid={2,2}), graphics={Line(points={{-93,88},{-88,88}}),Line(points={
            {-22.2,58},{-20,58}}),Line(points={{3,58},{6,58}})}), Documentation(
          info="This ASM3 plant consists of 2 denitrification tanks (tank1 and tank2),
...
"));
  ...
  model ComplexPlant "Complex ASM2d WWTP"
    ...
    mixer2 mixer2_1
      annotation (Placement(transformation(extent={{-45,16},{-25,36}})));
    mixer2 mixer2_2
      annotation (Placement(transformation(extent={{50,17},{70,37}})));
    mixer3 mixer3_1
      annotation (Placement(transformation(extent={{-107,14},{-87,34}})));
    mixer2 mixer2_5
    ...
    sensor_TSS sensor_TSS1
      annotation (Placement(transformation(extent={{-6,-87},{14,-67}})));
    ...
    WasteWater.ASM3.sensor_NH sensor_NH1
    ...
    Modelica.Blocks.Math.Feedback Feedback3 annotation (Placement(
          ...
          extent={{5,-5},{-5,5}},
          rotation=180)));
    WasteWater.ASM3.sensor_O2 sensor_O2_3
  ...
  equation
    ...
    connect(nitri3.Out, divider2_1.In)
      annotation (Line(points={{164,28},{190,28},{190,-35.3},{67.1,-35.3}}));
    connect(mixer2_5.Out, mixer3_1.In3) annotation (Line(points={{-120,-4.6},{-111,
            -4.6},{-111,19.1},{-107,19.1}}));
    ...
    connect(cdivider2.Out1, mixer2_2.In1)
      annotation (Line(points={{-22,80},{40,80},{40,29.5},{50,29.5}}));
    ...
    connect(FlowInput.Out, sensor_Q1.In) annotation (Line(points={{-156,97},{-148,
            97},{-148,90},{-194,90},{-194,76}}));
    ...
    connect(sensor_COD2.In, Preclaryfier.In)
      annotation (Line(points={{-108,94},{-108,90},{-136,90},{-136,78}}));
    ...
    connect(mixer2_1.Out, deni2.In)
      annotation (Line(points={{-24,27},{-22.5,27},{-22.5,23},{-21,23}}));
    ...
    connect(blower1.u, Gain2.y) annotation (Line(points={{163.9,-6},{195,-6},{
            195,103},{165,103}}, color={0,0,255}));
    connect(Settler.Feed, divider2_1.Out1)
      annotation (Line(points={{68,-72},{38.1,-72},{38.1,-38},{47.1,-38}}));
    connect(RecyclePump.Out, ControlledDivider2_1.In)
      annotation (Line(points={{0,-39},{-30,-39}}));
    connect(RecyclePump.In, divider2_1.Out2)
      annotation (Line(points={{21,-33},{47,-33}}));
    connect(ReturnController1.out, ReturnPump.u) annotation (Line(points={{-14,
            -108},{-8,-108},{-8,-97},{-35,-97}}, color={0,0,255}));
    connect(Settler.Return, ReturnPump.In)
      annotation (Line(points={{75,-84},{75,-91},{-33,-91}}));
    connect(Settler.Return, sensor_TSS1.In)
      annotation (Line(points={{75,-83.6},{75,-91},{4,-91},{4,-87}}));
    connect(sensor_COD1.In, Settler.Effluent)
      annotation (Line(points={{144,-57},{144,-68},{88,-68}}));
    connect(blower1.AirOut, nitri3.AirIn)
      annotation (Line(points={{154,7},{154,18}}));
    connect(nitri2.AirIn, blower2.AirOut)
      annotation (Line(points={{120,18},{120,7}}));
    connect(CombiTableTime2.y, Preclaryfier.MeasurePort) annotation (Line(
          points={{-125,105},{-122,105},{-122,87}}, color={0,0,255}));
    connect(cdivider2.In, Preclaryfier.Out)
      annotation (Line(points={{-42,78},{-116,78}}));
    connect(mixer2_1.In1, deni1.Out)
      annotation (Line(points={{-45,29},{-59,29},{-59,24},{-60,24}}));
    connect(mixer3_1.In2, anaerob.Out)
      annotation (Line(points={{-107,23},{-117,23}}));
    connect(nitri1.Out, mixer2_2.In2)
      annotation (Line(points={{32,24},{41,24},{41,25},{50,25}}));
    connect(blower3.AirOut, nitri1.AirIn)
      annotation (Line(points={{22,-3},{22,14.2}}));
    annotation (Diagram(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-200,-120},{200,120}},
          grid={1,1}), graphics), Documentation(info="This ASM3 example plant configuration is from a real municipal wastewater treatment plant
...
"));
  ...
  equation
    ...
    rXsto = Feed.Xsto/Xf;
    rXa = Feed.Xa/Xf;
    annotation (Documentation(info="This component models an ASM3 10 - layer secondary clarifier with 6 layers above the feed_layer (including top_layer)
...
"));
  ...
  annotation (Documentation(info="This package contains example ASM3 wastewater treatment plant models to demonstrate the usage of
