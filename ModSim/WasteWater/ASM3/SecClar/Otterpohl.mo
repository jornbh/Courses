...
package Otterpohl "Secondary settling tank modelling by Otterpohl"
  ...
  package Interfaces
    ...
    partial model SCVar "partial models providing variables"
      ...
      annotation (Documentation(info="partial models providing ASM3 variables"));
    end SCVar;
      ...
      Icon(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(extent={{-100,100},{100,-100}}),
            Polygon(
              ...
              pattern=LinePattern.None,
              fillColor={0,127,255},
              fillPattern=FillPattern.Solid),Text(extent={{-100,20},{100,-20}},
            textString="%name")}));
  end top_layer;
  annotation (Documentation(info="This package contains classes (layer models) to built ASM3 secondary clarifier models, an Interfaces sub-library
