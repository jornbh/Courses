...
package Krebs "Secondary settling tank modelling by Krebs (ASM3)"
  ...
  package Interfaces "Partial models for Secondary Clarifier Model by Krebs"
    ...
    annotation (Documentation(info="This package contains partial models for ASM3 secondary clarifier models.
...
"));
  ...
  equation
    ...
    der(Sn2_1) = (Feed.Q*Feed.Sn2 - (-Effluent.Q)*Sn2_1 - (-(Waste.Q + Return.Q))
      *Sn2_1)/(Asc*he/2);
    der(Snox1) = (Feed.Q*Feed.Snox - (-Effluent.Q)*Snox1 - (-(Waste.Q + Return.Q))
      *Snox1)/(Asc*he/2);
    ...
    Waste.Xsto = rXsto*XR;
    Waste.Xss = XR;
    annotation (Documentation(info="This component models an ASM3 secondary clarifier based on Krebs conceptional model.
...
"), Diagram(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(
              ...
              pattern=LinePattern.None,
              fillColor={0,127,255},
              fillPattern=FillPattern.Solid),Text(extent={{-90,78},{-34,66}},
            textString="top_layer"),Text(extent={{-90,20},{-30,-16}},
            textString="bottom_layer"),Line(
              points={{-90,48},{92,48}},
              color={0,0,255},
              pattern=LinePattern.Dash)}));
  end SecClarModKrebs;
  annotation (Documentation(info="This package contains an ASM3 secondary clarifier model and an Interfaces sub-library
