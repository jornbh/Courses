...
equation
  ...
  annotation (Documentation(info="This component models the ASM3 processes and reactions taking place in an unaerated (denitrification) tank
...
equation
  ...
  inputXa = (In.Xa - Xa)*In.Q/V;
  inputXss = (In.Xss - Xss)*In.Q/V;
  annotation (Documentaion(info="Nitrification Tank"), Documentation(info="This component models the ASM3 processes and reactions taking place in an aerated (nitrification) tank
of a wastewater treatment plant.
...
equation
  ...
  rXsto = Feed.Xsto/Xf;
  rXa = Feed.Xa/Xf;
  annotation (Documentation(info="This component models an ASM3 10 - layer secondary clarifier model with 4 layers above the feed_layer (including top_layer)
...
model pump "ASM3 wastewater pump"
  ...
  Interfaces.WWFlowAsm3out Out
    annotation (Placement(transformation(extent={{90,19},{110,39}})));
...
equation
  ...
  Out.Xa = In.Xa;
  Out.Xss = In.Xss;
  annotation (Documentation(info="This component models an ASM3 wastewater pump. It generates a wastewater flow
...
equation
  Out.Q = -data;
  annotation (Documentation(info="This component is used to feed an ASM3 wwtp model with flow data from measurement
...
equation
  ...
  annotation (Documentation(info="This component provides all ASM3 data at the influent of a wastewater treatment plant.
...
model EffluentSink "Receiving water (river)"
  ...
  annotation (Documentation(info="This component terminates an ASM3 wastewater treatment plant model e.g. the wastewater flow to the receiving water.
"));
end EffluentSink;
...
model SludgeSink "Wastesludge sink"
  ...
  annotation (Documentation(info="This component terminates the waste sludge stream of an ASM3 wastewater treatment plant model.
...
model ControlledDivider2 "Controlled flow divider"
  ...
  Interfaces.WWFlowAsm3in In
    annotation (Placement(transformation(extent={{-111,-6},{-91,14}})));
...
equation
  ...
  Out2.Xa = In.Xa;
  Out2.Xss = In.Xss;
  annotation (Documentation(info="This component divides one wastewater flow (ASM3) into two flows which are controlled by the signal u (0...1).
...
model divider2 "Flowdivider"
  ...
  Interfaces.WWFlowAsm3in In
    annotation (Placement(transformation(extent={{-111,-7},{-91,13}})));
  Interfaces.WWFlowAsm3out Out1
    annotation (Placement(transformation(extent={{89,20},{109,40}})));
  Interfaces.WWFlowAsm3out Out2
    annotation (Placement(transformation(extent={{90,-28},{110,-8}})));
equation
...
model mixer2 "Mixer of two ASM3 characterised flows"
  ...
  Interfaces.WWFlowAsm3in In1
    annotation (Placement(transformation(extent={{-111,20},{-91,40}})));
  Interfaces.WWFlowAsm3in In2
    annotation (Placement(transformation(extent={{-111,-30},{-91,-10}})));
  Interfaces.WWFlowAsm3out Out
    annotation (Placement(transformation(extent={{90,-5},{110,15}})));
equation
  In1.Q + In2.Q + Out.Q = 0;
...
model mixer3 "Mixer of 3 ASM3 characterised flows"
  ...
  Interfaces.WWFlowAsm3in In1
    annotation (Placement(transformation(extent={{-110,29},{-90,49}})));
  Interfaces.WWFlowAsm3in In2
    annotation (Placement(transformation(extent={{-111,-14},{-91,6}})));
  Interfaces.WWFlowAsm3in In3
    annotation (Placement(transformation(extent={{-109,-59},{-89,-39}})));
  Interfaces.WWFlowAsm3out Out
    annotation (Placement(transformation(extent={{90,-13},{110,7}})));
equation
...
"), Diagram(coordinateSystem(
        ...
        grid={2,2}), graphics={Ellipse(
            ...
            fillPattern=FillPattern.Solid),Line(points={{0,50},{0,38}},
          thickness=0.5),Line(points={{-50,0},{38,0}}, thickness=0.5),Line(
          points={{50,0},{38,0}}, thickness=0.5),Line(points={{-36,34},{-28,26}},
          thickness=0.5),Line(points={{34,36},{26,28}}, thickness=0.5),Line(
          points={{0,0},{26,28}}, thickness=0.5),Polygon(
          ...
          points={{50,0},{88,0}}),Text(extent={{-80,100},{80,60}}, textString=
          "%name")}));
end sensor_O2;
...
equation
  ...
  In.Xa = Out.Xa;
  In.Xss = Out.Xss;
  annotation (Documentation(info="This component measures the flow of an ASM3 wastewater stream and provides
