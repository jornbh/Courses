...
package PreClar "Primary clarifier modelling based on ASM3"
  ...
  equation
    ...
    annotation (Documentation(info="This is an ASM3 dynamic primary clarifier model based on the theory
...
"));
  ...
  equation
    ...
    MeasurePort.Xss = i_SS_Xi*Out.Xi + i_SS_Xs*Out.Xs + i_SS_BM*Out.Xh + 0.60*
      Out.Xsto + i_SS_BM*Out.Xa;
    annotation (Documentation(info="This is an ASM3 static primary clarifier model based on the theory
by Otterpohl and Freund.
...
"));
  ...
  equation
    ...
    Out.Xss = i_SS_Xi*Out.Xi + i_SS_Xs*Out.Xs + i_SS_BM*Out.Xh + 0.60*Out.Xsto
       + i_SS_BM*Out.Xa;
    annotation (Documentation(info="This is a special case of the ASM3 static primary clarifier model.
...
"));
  ...
  annotation (Documentation(info="This package provides one dynamic and two static ASM3 primary clarifier
