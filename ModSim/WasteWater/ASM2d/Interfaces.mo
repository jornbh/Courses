  ...
  connector WWFlowAsm2din "Inflow connector of ASM2d components"
    ...
    annotation (Icon(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(
              ...
              textString="%name")}), Documentation(info="Connectors WWFlowAsm2din and WWFlowAsm2dout are nearly identical.
  ...
  connector WWFlowAsm2dout "Outflow connector of ASM2d components"
    ...
    annotation (Icon(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(extent={{-100,100},{100,-100}}),Text(
            extent={{-88,92},{94,-92}}, textString="%name")}), Documentation(
          info="Connectors WWFlowAsm2din and WWFlowAsm2dout are nearly identical.
The difference is in the icons to more easily identify the inflow and outflow
side of a component.
The connector consists of one flow variable and 19 potential variables (ASM2d concentrations).
"));
  ...
  connector AirFlow "Airflow connector"
    ...
    annotation (Documentation(info="The Airflow connector consists of a flow variable describing the exchange of
