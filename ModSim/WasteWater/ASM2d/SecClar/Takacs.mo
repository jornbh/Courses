...
package Takacs "Secondary settling tank modelling by Takacs"
  ...
  package Interfaces
    ...
    partial model SCVar "partial models providing variables"
      ...
      annotation (Documentation(info="partial models providing ASM2d variables"));
    end SCVar;
...
function by Takacs."),
  ...
  annotation (Documentation(info="This package contains classes (layer models) to built ASM1 secondary clarifier models, an Interfaces sub-library
