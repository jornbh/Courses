...
package Krebs "Secondary settling tank modelling by Krebs (ASM2d)"
  ...
  package Interfaces "Partial models for Secondary Clarifier Model by Krebs"
    ...
    annotation (Documentation(info="This package contains partial models for ASM2d secondary clarifier models.
...
"));
  ...
  equation
    ...
    Waste.Xmep = rXmep*XR;
    Waste.Xtss = XR;
    annotation (Documentation(info="This component models an ASM2d secondary clarifier based on Krebs conceptional model.
...
"), Diagram(coordinateSystem(
  ...
  annotation (Documentation(info="This package contains an ASM2d secondary clarifier model and an Interfaces sub-library
