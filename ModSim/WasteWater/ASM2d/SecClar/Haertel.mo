...
package Haertel "Secondary settling tank modelling by Haertel (ASM2d)"
  ...
  package Interfaces
    ...
    partial model SCVar "partial models providing variables"
      ...
      annotation (Documentation(info="partial models providing variables"));
    end SCVar;
    ...
    algorithm
      ...
      //[l/g]
      vS := v0*exp(-nv*X/1000);
      annotation (Documentation(info="Sedimentation velocity function"));
    end vSfun;
    ...
    annotation (Documentation(info="This package contains connectors and interfaces (partial models) for
...
"));
  ...
  equation
    ...
    connect(Feed, S8.In)
      annotation (Line(points={{-98,14},{-98,47.8},{-33,47.8}}));
    ...
    rXmep = Feed.Xmep/Xf;
    annotation (Documentation(info="This component models an ASM2d 10 - layer secondary clarifier with 4 layers above the feed_layer (including top_layer)
...
"));
  ...
  model bottom_layer "Bottom layer of Haertel`s SC model"
    ...
    extends WWSC.SCVar;
    extends WWSC.ratios;
    ASM2d.Interfaces.WWFlowAsm2dout PQr
      annotation (Placement(transformation(extent={{-70,-110},{-50,-90}})));
    ASM2d.Interfaces.WWFlowAsm2dout PQw
...
"),   Diagram(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(extent={{-100,100},{100,-100}}),
            Polygon(
              ...
              fillColor={0,127,255},
              fillPattern=FillPattern.Solid),Polygon(
              points={{52,68},{52,50},{44,50},{60,40},{76,50},{68,50},{68,68},{
              52,68}},
              lineColor={0,0,255},
              pattern=LinePattern.None,
      ...
      Icon(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-100,-100},{100,100}},
          grid={2,2}), graphics={Rectangle(extent={{-100,100},{100,-100}}),Text(
            extent={{-100,20},{100,-20}}, textString="%name"),Polygon(
              points={{-68,-40},{-68,-58},{-76,-58},{-60,-68},{-44,-58},{-52,-58},
              {-52,-40},{-68,-40}},
              lineColor={0,0,255},
              pattern=LinePattern.None,
...
"),   Diagram(coordinateSystem(
  ...
  model feed_layer "Influent layer of Haertel`s SC model"
    ...
    WWSC.UpperLayerPin Up
      annotation (Placement(transformation(extent={{-10,90},{10,110}})));
    ASM2d.Interfaces.WWFlowAsm2din In
  ...
  equation
    ...
    Jsm = if vS < Dn.vS_dn then omega*(vS*X) else omega*min(vS*X, Dn.vS_dn*Dn.X_dn);
    // ODE of solid component
    der(X) = (In.Q/Asc*Xf - (-Up.Qe)/Asc*X - (-(Dn.Qr + Dn.Qw))/Asc*X + Up.SedFlux
       - Jsm)/zm;
...
function by Haertel."),
  ...
  model top_layer "Effluent layer of Haertel`s SC model"
    ...
    WWSC.UpperLayerPin Dn
      annotation (Placement(transformation(extent={{-10,-110},{10,-90}})));
    ASM2d.Interfaces.WWFlowAsm2dout Out
...
"),   Diagram(coordinateSystem(
          ...
          grid={2,2}), graphics={Rectangle(extent={{-100,100},{100,-100}}),
            Polygon(
              ...
              fillColor={223,191,159},
              fillPattern=FillPattern.Solid),Polygon(
              points={{-8,58},{-8,40},{10,40},{10,32},{22,50},{10,66},{10,58},{
              -8,58}},
              lineColor={0,0,255},
              pattern=LinePattern.None,
              fillColor={0,127,255},
  ...
  annotation (Documentation(info="This package contains classes (layer models) to built ASM2d secondary clarifier models, an Interfaces sub-library
