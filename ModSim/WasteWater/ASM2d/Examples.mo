...
package Examples
  ...
  class SmallPlant "Small WWTP Configuration"
    ...
    Modelica.Blocks.Sources.Constant Constant1
      annotation (Placement(transformation(extent={{-66,-89},{-46,-69}})));
    ...
    ASM2d.pump ReturnPump(Q_max=9223) annotation (Placement(transformation(
          ...
          extent={{-10,-10},{10,10}},
          rotation=180)));
    ASM2d.pump WastePump(Q_max=193)
    ...
    sensor_NH sensor_NH1
      annotation (Placement(transformation(extent={{64,15},{80,31}})));
    ...
    WasteWater.ASM2d.SecClar.Krebs.SecClarModKrebs Settler
      annotation (Placement(transformation(extent={{49,-7},{69,13}})));
  equation
    ...
    connect(mixer.Out, tank1.In)
      annotation (Line(points={{-84,32},{-74.5,32},{-74.5,4},{-65,4}}));
    ...
    connect(blower1.AirOut, tank2.AirIn)
      annotation (Line(points={{-22,-42},{-22,-5.8}}));
    connect(blower2.AirOut, tank3.AirIn)
      annotation (Line(points={{5,-42},{5,-23.9},{5,-23.9},{5,-5.8}}));
    connect(tank3.MeasurePort, sensor_O2.In)
      annotation (Line(points={{10.5,8.5},{10,8.5},{10,18}}));
    connect(Feedback.y, PI1.u) annotation (Line(points={{81,50},{86,50}}));
    connect(PI1.y, blower2.u) annotation (Line(points={{109,50},{114,50},{114,-84},
            {18,-84},{18,-56},{15.8,-56}}));
    connect(divider.Out2, RecyclePump.In)
      annotation (Line(points={{40,2},{44,2},{44,-8.7},{-74,-8.7}}));
    connect(RecyclePump.Out, mixer.In3)
      annotation (Line(points={{-94.2,-14.8},{-104,-14.8},{-104,28}}));
    ...
    connect(Temperature.y, tank1.T) annotation (Line(points={{-81.5,56},{-69,56},
            {-69,8},{-65,8}}, color={0,0,255}));
    connect(Temperature.y, tank2.T)
      annotation (Line(points={{-81.5,56},{-32,56},{-32,8}}, color={0,0,255}));
    connect(Temperature.y, tank3.T) annotation (Line(points={{-81.5,56},{-5.9,
            56},{-5.9,8},{-5.8,8}}, color={0,0,255}));
    connect(OxygenSetpoint.y, Feedback.u1)
      annotation (Line(points={{58,50},{64,50}}, color={0,0,255}));
    connect(blower1.u, Constant1.y) annotation (Line(points={{-12.2,-55},{-9,-55},
            {-9,-79},{-44,-79}}, color={0,0,255}));
    connect(WastePump.Out, WasteSludge.In)
      annotation (Line(points={{79,-42},{87,-42}}));
    connect(WastePump.u, Constant2.y) annotation (Line(points={{60,-43},{46,-43},
            {46,-58},{44,-58}}, color={0,0,255}));
    connect(tank1.Out, tank2.In) annotation (Line(points={{-44,4},{-32,4}}));
    connect(RecyclePump.u, Constant1.y) annotation (Line(points={{-75,-15},{-38,
            -15},{-38,-79},{-45,-79}}, color={0,0,255}));
    connect(divider.Out1, Settler.Feed)
      annotation (Line(points={{40,6.6},{44,6.6},{44,4.4},{48,4.4}}));
    connect(Settler.Effluent, Effluent.In)
      annotation (Line(points={{68.2,8.7},{78,8.7},{78,-15},{88,-15}}));
    connect(Settler.Return, ReturnPump.In)
      annotation (Line(points={{55,-6.6},{55,-22.7},{36,-22.7}}));
    ...
    connect(sensor_NH1.In, Settler.Effluent)
      annotation (Line(points={{72,15},{72,8.7},{69,8.7}}));
    connect(sensor_NO1.In, Settler.Effluent)
      annotation (Line(points={{89,15},{89,8.7},{68.2,8.7}}));
    connect(sensor_TKN1.In, Settler.Effluent)
      annotation (Line(points={{105,14},{105,8.7},{68.2,8.7}}));
    connect(sensor_COD1.In, Settler.Effluent)
      annotation (Line(points={{105,-5},{105,8.7},{68.2,8.7}}));
    connect(Constant2.y, ReturnPump.u) annotation (Line(points={{43,-58},{46,-58},
            {46,-28},{34.8,-28}}, color={0,0,255}));
    annotation (Diagram(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-120,-100},{120,105}},
          grid={1,1}), graphics={Line(points={{-22,58},{-22,58}}, color={0,0,
            255})}), Documentation(info="This fictitious plant provides an ASM2d example model with a small number of equations.
...
"));
  ...
  class BenchPlant "COST Benchmark WWTP Configuration"
    ...
    ASM2d.SludgeSink WasteSludge
      annotation (Placement(transformation(extent={{87,-51},{107,-31}})));
    ASM2d.SecClarModTakacs Settler
      annotation (Placement(transformation(extent={{49,-5},{69,15}})));
    ASM2d.divider2 divider
      annotation (Placement(transformation(extent={{20,-6},{40,14}})));
    ASM2d.nitri tank5(V=1333)
      annotation (Placement(transformation(extent={{-6,-6},{14,14}})));
    ASM2d.nitri tank4(V=1333)
      annotation (Placement(transformation(extent={{-32,-6},{-12,14}})));
    ASM2d.nitri tank3(V=1333)
    ...
    ASM2d.pump ReturnPump(Q_max=18446) annotation (Placement(transformation(
          ...
          extent={{-10,-10},{10,10}},
          rotation=180)));
    ASM2d.pump WastePump(Q_max=385)
      annotation (Placement(transformation(extent={{59,-55},{79,-35}})));
    Modelica.Blocks.Sources.Constant Constant2
      annotation (Placement(transformation(extent={{22,-68},{42,-48}})));
    Modelica.Blocks.Sources.Constant Temperature(k=15)
  ...
  equation
    ...
    connect(Limiter1.y, Feedback1.u2)
      annotation (Line(points={{29,58},{32,58},{32,80}}));
    connect(Settler.Return, ReturnPump.In)
      annotation (Line(points={{55,-4.6},{55,-22.7},{36,-22.7}}));
    connect(ReturnPump.Out, mixer.In2) annotation (Line(points={{16,-28},{15.5,
            -28},{15.5,-30},{-112,-30},{-112,32},{-104,32}}));
    connect(sensor_O2.So, Feedback.u2)
      annotation (Line(points={{19.8,28},{72,28},{72,42}}));
    connect(Temperature.y, tank1.T) annotation (Line(points={{-81.5,56},{-78,56},
            {-78,36},{-75.8,36}}, color={0,0,255}));
    connect(Temperature.y, tank2.T) annotation (Line(points={{-81.5,56},{-52,56},
            {-52,36},{-48,36}}, color={0,0,255}));
    ...
    connect(blower2.u, Constant1.y) annotation (Line(points={{-12.2,-55},{-9,-55},
            {-9,-79},{-44,-79}}, color={0,0,255}));
    connect(WastePump.Out, WasteSludge.In)
      annotation (Line(points={{79,-42},{87,-42}}));
    connect(WastePump.In, Settler.Waste) annotation (Line(points={{59,-48},{52,
    ...
    connect(WastePump.u, Constant2.y) annotation (Line(points={{60,-43},{46,-43},
            {46,-58},{44,-58}}, color={0,0,255}));
    connect(sensor_NH1.In, Settler.Effluent)
      annotation (Line(points={{72,15},{72,11},{69,11}}));
    connect(sensor_NO1.In, Settler.Effluent)
      annotation (Line(points={{89,15},{89,11},{70,11}}));
    connect(sensor_TKN1.In, Settler.Effluent)
      annotation (Line(points={{105,14},{105,11},{70,11}}));
    connect(sensor_COD1.In, Settler.Effluent)
      annotation (Line(points={{105,-5},{105,11},{70,11}}));
    connect(Constant2.y, ReturnPump.u) annotation (Line(points={{43,-58},{46,-58},
            {46,-28.5},{34.8,-28.5}}, color={0,0,255}));
    connect(divider.Out1, Settler.Feed)
      annotation (Line(points={{41,6.5},{45,6.5},{45,6.4},{49,6.4}}));
    connect(Effluent.In, Settler.Effluent)
      annotation (Line(points={{88,-17},{78.5,-17},{78.5,11},{69,11}}));
    annotation (Diagram(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-120,-100},{120,105}},
          grid={1,1}), graphics), Documentation(info="This ASM2d example plant consists of 2 denitrification tanks (tank1 and tank2),
...
"));
  ...
  model ComplexPlant "Complex ASM2d WWTP"
    ...
    ControlledDivider2 cdivider1
      annotation (Placement(transformation(extent={{-168,65},{-148,85}})));
    ...
    nitri nitri2(
      ...
      de=5.24,
      R_air=20)
      annotation (Placement(transformation(extent={{110,18},{130,38}})));
    deni anaerob(V=1287)
      annotation (Placement(transformation(extent={{-138,13},{-118,33}})));
    deni deni1(V=2772)
    ...
    ControlledDivider2 cdivider2
      annotation (Placement(transformation(extent={{-42,67},{-22,87}})));
    ...
    mixer2 mixer2_1
      annotation (Placement(transformation(extent={{-47,12},{-27,32}})));
    mixer2 mixer2_2
      annotation (Placement(transformation(extent={{50,17},{70,37}})));
    mixer3 mixer3_1
      annotation (Placement(transformation(extent={{-106,14},{-86,34}})));
    mixer2 mixer2_5
      annotation (Placement(transformation(extent={{-140,-15},{-120,5}})));
    ...
    mixer2 mixer2_3
      annotation (Placement(transformation(extent={{-168,18},{-148,38}})));
    ...
    FlowSource FlowInput
      annotation (Placement(transformation(extent={{-178,95},{-158,115}})));
    ...
    Modelica.Blocks.Sources.Constant Constant6
      annotation (Placement(transformation(extent={{-46,-10},{-36,0}})));
    ...
    sensor_NH sensor_NH2
      annotation (Placement(transformation(extent={{112,-56},{132,-36}})));
    ...
    precipitation precipitation1(V=22, beta=8)
    ...
    WasteWater.Misc.ReturnController ReturnController1
      annotation (Placement(transformation(extent={{-28,-115},{-14,-101}})));
    sensor_Q sensor_Q1
      annotation (Placement(transformation(extent={{-194,66},{-174,86}})));
    WasteWater.Misc.TwoPoint TwoPoint1(
      on=4.5,
      off=4.0,
      out_on=2.5,
      out_off=1.5)
      annotation (Placement(transformation(extent={{-8,100},{2,110}})));
    WasteWater.Misc.TwoPoint TwoPoint2(
      on=4.5,
      off=4.0,
      out_on=2.5,
      out_off=1.5)
      annotation (Placement(transformation(extent={{110,100},{120,110}})));
    WasteWater.ASM2d.sensor_NH sensor_NH1
      annotation (Placement(transformation(extent={{142,38},{162,58}})));
    Modelica.Blocks.Math.Feedback Feedback1
      annotation (Placement(transformation(extent={{12,100},{22,110}})));
    Modelica.Blocks.Math.Feedback Feedback2
      annotation (Placement(transformation(extent={{127,99},{137,109}})));
    WasteWater.ASM2d.sensor_O2 sensor_O2_1
      annotation (Placement(transformation(extent={{164,38},{184,58}})));
    WasteWater.ASM2d.sensor_O2 sensor_O2_2
      annotation (Placement(transformation(extent={{14,38},{34,58}})));
    WasteWater.ASM2d.sensor_COD sensor_COD1
      annotation (Placement(transformation(extent={{134,-56},{154,-36}})));
    WasteWater.ASM2d.sensor_COD sensor_COD2
      annotation (Placement(transformation(extent={{-116,95},{-97,114}})));
    ...
    WasteWater.ASM2d.sensor_TP sensor_TP1
      annotation (Placement(transformation(extent={{-93,94},{-74,114}})));
    WasteWater.ASM2d.sensor_TKN sensor_TKN1
      annotation (Placement(transformation(extent={{68,-56},{88,-36}})));
    WasteWater.ASM2d.sensor_TP sensor_TP2
      annotation (Placement(transformation(extent={{-150,98},{-136,112}})));
    WasteWater.ASM2d.sensor_TP sensor_TP3
      annotation (Placement(transformation(extent={{156,-54},{174,-36}})));
    Modelica.Blocks.Sources.CombiTimeTable CombiTableTime1(
      fileName=Modelica.Utilities.Files.loadResource(
          "modelica://WasteWater/Resources/ASM2d/drysim130303.txt"),
      table=[0, 0; 1, 1],
      columns=integer(({2})),
    ...
    Modelica.Blocks.Math.Feedback Feedback3 annotation (Placement(
          ...
          extent={{5,-5},{-5,5}},
          rotation=180)));
    WasteWater.ASM2d.sensor_O2 sensor_O2_3
      annotation (Placement(transformation(extent={{116,40},{134,58}})));
    Modelica.Blocks.Math.Gain Gain1(k=500)
      annotation (Placement(transformation(extent={{29,95},{49,115}})));
    Modelica.Blocks.Math.Gain Gain2(k=500)
      annotation (Placement(transformation(extent={{144,93},{164,113}})));
    Modelica.Blocks.Math.Gain Gain3(k=500)
      annotation (Placement(transformation(extent={{94,-28},{108,-14}})));
    WasteWater.Misc.TwoPoint TwoPoint3(
      on=4.5,
      off=4.0,
      out_on=2.0,
      out_off=1.0)
      annotation (Placement(transformation(extent={{63,-19},{75,-7}})));
    Modelica.Blocks.Sources.Step Step1(
      height=0.125,
      offset=-0.5,
      startTime=2.375)
      annotation (Placement(transformation(extent={{100,-90},{110,-80}})));
  equation
    connect(deni3.Out, nitri2.In) annotation (Line(points={{100,28},{110,28}}));
    connect(nitri2.Out, nitri3.In)
      annotation (Line(points={{130,28},{144,28}}));
    connect(nitri3.Out, divider2_1.In)
      annotation (Line(points={{164,28},{190,28},{190,-32.3},{76,-32.3}}));
    connect(mixer2_5.Out, mixer3_1.In3) annotation (Line(points={{-120,-4.6},{-111,
            -4.6},{-111,20.5},{-107,20.5}}));
    connect(Constant4.y, cdivider3.u) annotation (Line(points={{-137.5,-75},{-122,
            -75},{-122,-81}}, color={0,0,255}));
    connect(nitri1.Out, mixer2_2.In2)
      annotation (Line(points={{33,24},{39,24},{39,25.5},{51,25.5}}));
    connect(deni2.Out, nitri1.In)
      annotation (Line(points={{5.55112e-16,24},{12,24}}));
    connect(cdivider2.Out1, mixer2_2.In1)
      annotation (Line(points={{-22,78.5},{40,78.5},{40,29.5},{50,29.5}}));
    connect(cdivider3.Out2, mixer2_5.In1) annotation (Line(points={{-132,-85.5},
            {-172,-85.5},{-172,-2.5},{-140,-2.5}}));
    connect(Constant7.y, cdivider2.u) annotation (Line(points={{-55.5,103},{-50.5,
            103},{-50.5,54},{-32,54},{-32,70}}, color={0,0,255}));
    ...
    connect(WastePump.Out, WasteSludge.In)
      annotation (Line(points={{148.2,-91.2},{170,-91.2}}));
    ...
    connect(mixer2_2.Out, deni3.In)
      annotation (Line(points={{70,27.4},{70,28},{80,28}}));
    connect(sensor_NO1.In, deni2.MeasurePort)
      annotation (Line(points={{-4,40},{-4,28.5},{-4.5,28.5}}));
    ...
    connect(Temperature.y, deni3.T) annotation (Line(points={{80,54},{94,54},{
            94,34},{80,34},{80,32}}, color={0,0,255}));
    ...
    connect(precipitation1.In, divider2_1.Out1)
      annotation (Line(points={{42,-72},{38,-72},{38,-34.5},{56,-34.5}}));
    connect(precipitation1.T, Temperature.y) annotation (Line(points={{42,-68},
            {42,34},{94,34},{94,54},{80,54}}, color={0,0,255}));
    ...
    connect(sensor_NH1.In, nitri3.MeasurePort)
      annotation (Line(points={{152,38},{152,34},{160,34},{160,32.5}}));
    connect(sensor_O2_2.In, nitri1.MeasurePort)
      annotation (Line(points={{24,38},{24,28.5},{28,28.5}}));
    connect(Feedback1.u2, sensor_O2_2.So) annotation (Line(points={{17,101},{17,
            83.5},{34,83.5},{34,48}}, color={0,0,255}));
    connect(sensor_O2_1.In, nitri3.MeasurePort) annotation (Line(points={{174,
            38},{174,34},{160.25,34},{160.25,32},{160,32}}));
    connect(Feedback2.u2, sensor_O2_1.So) annotation (Line(points={{132,101},{
            132,81},{184,81},{184,48}}, color={0,0,255}));
    ...
    connect(sensor_COD2.In, Preclaryfier.In)
      annotation (Line(points={{-107,95},{-107,78},{-136,78}}));
    connect(sensor_NO3.In, Settler.Effluent)
      annotation (Line(points={{100,-56},{100,-68.3},{88.2,-68.3}}));
    connect(sensor_NH2.In, Settler.Effluent)
      annotation (Line(points={{122,-56},{122,-68.3},{88.2,-68.3}}));
    connect(precipitation1.Out, Settler.Feed)
      annotation (Line(points={{62,-72},{65,-72},{65,-72.6},{68,-72.6}}));
    connect(WastePump.In, Settler.Waste)
      annotation (Line(points={{128,-97.3},{82,-97.3},{82,-84}}));
    connect(Settler.Return, ReturnPump.In)
      annotation (Line(points={{74,-84},{74,-90.7},{-34,-90.7}}));
    connect(sensor_TSS1.In, Settler.Return)
      annotation (Line(points={{4,-86},{4,-91},{74,-91},{74,-84}}));
    connect(sensor_TP1.In, Preclaryfier.Out)
      annotation (Line(points={{-84,94},{-84,78},{-116,78}}));
    connect(sensor_TKN1.In, Settler.Effluent)
      annotation (Line(points={{78,-56},{88,-56},{88,-68}}));
    connect(sensor_TP2.In, Preclaryfier.In)
      annotation (Line(points={{-143,98},{-143,78},{-136,78}}));
    ...
    connect(sensor_O2_3.In, nitri2.MeasurePort)
      annotation (Line(points={{125,40},{125,32.5},{126,32.5}}));
    connect(sensor_Q1.Out, cdivider1.In)
      annotation (Line(points={{-174,76},{-168,76}}));
    connect(cdivider2.Out2, mixer3_1.In1) annotation (Line(points={{-22,76},{-18,
            76},{-18,47},{-111,47},{-111,28.5},{-107,28.5}}));
    connect(mixer3_1.Out, deni1.In)
      annotation (Line(points={{-87,24},{-81,24}}));
    ...
    connect(mixer2_3.Out, anaerob.In)
      annotation (Line(points={{-148,29},{-143,29},{-143,23},{-138,23}}));
    connect(Gain1.u, Feedback1.y) annotation (Line(points={{27,104},{24,104},{
            24,105},{21,105}}, color={0,0,255}));
    connect(Gain2.u, Feedback2.y) annotation (Line(points={{141,103},{139,103},
            {139,104},{137,104}}, color={0,0,255}));
    connect(Feedback3.y, Gain3.u) annotation (Line(points={{88.5,-13},{90.55,-13},
            {90.55,-21},{92.6,-21}}, color={0,0,255}));
    ...
    connect(blower3.AirOut, nitri1.AirIn)
      annotation (Line(points={{21,-3},{21,5.5},{22,5.5},{22,14}}));
    connect(blower1.AirOut, nitri3.AirIn)
      annotation (Line(points={{155,8},{155,13},{154,5.5},{154,18}}));
    connect(Constant2.y, cdivider1.u) annotation (Line(points={{-167.5,57},{-158,
            57},{-158,69}}, color={0,0,255}));
    ...
    connect(blower1.u, Gain2.y) annotation (Line(points={{165.8,-5},{195,-5},{
            195,103},{165,103}}, color={0,0,255}));
    connect(CombiTableTime1.y[1], FlowInput.data)
      annotation (Line(points={{-183.3,105},{-178,105}}, color={0,0,255}));
    connect(sensor_Q1.In, FlowInput.Out)
      annotation (Line(points={{-194,76},{-194,89},{-158,89},{-158,98}}));
    connect(ReturnPump.u, ReturnController1.out) annotation (Line(points={{-35.2,
            -97},{-5,-97},{-5,-108},{-13,-108}}, color={0,0,255}));
    connect(ControlledDivider2_1.In, RecyclePump.Out)
      annotation (Line(points={{-32,-36},{0,-36}}));
    connect(divider2_1.Out2, RecyclePump.In)
      annotation (Line(points={{56,-30},{20,-30}}));
    connect(mixer2_1.In1, deni1.Out)
      annotation (Line(points={{-47,24},{-60,24}}));
    connect(mixer2_1.Out, deni2.In)
      annotation (Line(points={{-27,22},{-23.5,22},{-23.5,24},{-20,24}}));
    connect(mixer3_1.In2, anaerob.Out)
      annotation (Line(points={{-107,23},{-118,23}}));
    connect(cdivider2.In, Preclaryfier.Out)
      annotation (Line(points={{-42,77},{-84,77},{-84,78},{-116,78}}));
    connect(blower2.AirOut, nitri2.AirIn)
      annotation (Line(points={{120,7},{120,18.2}}));
    connect(Settler.Effluent, sensor_COD1.In)
      annotation (Line(points={{89,-68},{145,-68},{145,-55}}));
    connect(Effluent.In, Settler.Effluent)
      annotation (Line(points={{170,-61},{165,-61},{165,-68},{88,-68}}));
    connect(sensor_TP3.In, Settler.Effluent)
      annotation (Line(points={{165,-54},{165,-68},{88,-68}}));
    annotation (Diagram(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-200,-120},{200,120}},
          grid={1,1}), graphics), Documentation(info="This ASM2d example plant configuration is from a real municipal wastewater treatment plant
...
"));
  ...
  model JenaSecClarModTakacs
    ...
    WI.WWFlowAsm2dout Effluent
      annotation (Placement(transformation(extent={{92,47},{112,67}})));
    ...
    SCP.bottom_layer S1(
      ...
      rXmeoh=rXmeoh,
      rXmep=rXmep)
      annotation (Placement(transformation(extent={{-35,-93},{35,-78}})));
    SCP.lower_layer S2(
      zm=zm,
      Asc=Asc,
    ...
    SCP.top_layer S10(
      ...
      rXmeoh=rXmeoh,
      rXmep=rXmep)
      annotation (Placement(transformation(extent={{-35,78},{35,93}})));
  equation
    connect(S1.Up, S2.Dn)
      annotation (Line(points={{-2.22045e-15,-78},{-2.22045e-15,-74}}));
    connect(S2.Up, S3.Dn)
      annotation (Line(points={{-2.22045e-15,-59},{-2.22045e-15,-55}}));
    connect(S7.Up, S8.Dn)
      annotation (Line(points={{-2.22045e-15,36},{-2.22045e-15,40}}));
    connect(S9.Up, S10.Dn)
      annotation (Line(points={{-2.22045e-15,74},{-2.22045e-15,78}}));
    connect(S8.Up, S9.Dn)
      annotation (Line(points={{-2.22045e-15,55},{-2.22045e-15,59}}));
    connect(S1.PQw, Waste)
      annotation (Line(points={{17.5,-93},{30,-93},{30,-100}}));
    connect(S10.Out, Effluent)
      annotation (Line(points={{35,85.5},{67.5,85.5},{67.5,57},{100,57}}));
    connect(S1.PQr, Return)
      annotation (Line(points={{-21,-93},{-30,-93},{-30,-100}}));
    ...
    connect(Feed, S4.In) annotation (Line(points={{-100,10},{-67.5,10},{-67.5,-28.72},
            {-35,-28.72}}));
    // total sludge concentration in clarifier feed
    Xf = Feed.Xtss;
    ...
    rXmep = Feed.Xmep/Xf;
    annotation (Documentation(info="This component models an ASM2d 10 - layer secondary clarifier with 6 layers above the feed_layer (including top_layer)
...
"));
  ...
  annotation (Documentation(info="This package contains example ASM2d wastewater treatment plant models to demonstrate the usage of
