...
package PreClar "Primary clarifier modelling based on ASM2d"
  ...
  model preclar1 "Dynamic ASM2d Primary Clarifier Model"
    ...
    ASM2d.Interfaces.WWFlowAsm2dout MeasurePort
  ...
  equation
    ...
    annotation (Documentation(info="This is an ASM2d dynamic primary clarifier model based on the theory
...
"));
  ...
  equation
    ...
    MeasurePort.Xmeoh = 0.0;
    MeasurePort.Xmep = 0.0;
    annotation (Documentation(info="This is an ASM2d static primary clarifier model based on the theory
by Otterpohl and Freund.
...
"));
  ...
  model preclar3 "Inverse ASM2d Static Primary Clarifier Model"
    ...
    ASM2d.Interfaces.WWFlowAsm2dout Out
      annotation (Placement(transformation(extent={{90,-10},{110,10}})));
    Modelica.Blocks.Interfaces.RealInput MeasurePort[4] annotation (Placement(
          transformation(
          origin={38,90},
          extent={{-10,-10},{10,10}},
          rotation=270)));
  equation
    ...
    Out.Xmeoh = 0.0;
    Out.Xmep = 0.0;
    annotation (Documentation(info="This is a special case of the ASM2d static primary clarifier model.
...
"));
  ...
  annotation (Documentation(info="This package provides one dynamic and two static ASM2d primary clarifier
